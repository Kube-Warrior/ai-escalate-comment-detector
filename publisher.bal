...
service / on new http:Listener(9090) {
    resource function post escalations(EscalationRequest escalationRequest) returns EscalationResponse|EscalationResponseError {
        ...
        do {
            ...
            EscalationResponse escalationResponse = generateEscalationResponse(escalationRequest, openAIResponse);
...
function generateEscalationResponse(EscalationRequest escalationRequest, OpenAIResponse openAIResponse) returns EscalationResponse
    => {
